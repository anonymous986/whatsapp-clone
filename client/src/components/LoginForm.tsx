          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                id="remember"
                className="w-4 h-4 text-wa-accent bg-wa-dark-tertiary border-wa-dark-border rounded focus:ring-wa-accent/50"
                disabled={loading}
              />
              <label htmlFor="remember" className="ml-2 text-sm text-wa-text-secondary">
                Remember me
              </label>
            </div>
